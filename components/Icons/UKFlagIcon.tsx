...
export const UKFlagIcon: FC<IconProps> = ({ ...rest }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="2500" height="1248" viewBox="0 0 216.156 107.929" {...rest}>
      <g fillRule="evenodd" clipRule="evenodd" strokeWidth=".216" strokeMiterlimit="2.613">
