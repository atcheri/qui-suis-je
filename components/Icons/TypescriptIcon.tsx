...
export const TypescriptIcon: FC<IconProps> = ({ active = true, ...rest }) => {
  return (
    <svg height="2500" viewBox="0 0 640 640" width="2500" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <path d="m0 0h640v640h-640z" fill={`${!active ? 'grey' : '#017acb'}`} />
      <path
        fill="#fff"
